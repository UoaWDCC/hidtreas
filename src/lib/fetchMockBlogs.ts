export async function fetchMockBlogs() {
    return [
        ...
        },
        {
            ...
            description: "This small habit change surprisingly fixed my sleep schedule and made mornings less miserable.",
            imageUrl: "/groupPic.png",
        },
        {
            id: 3,
        ...
        },
        {
            ...
            description: "Good coffee, strong Wi-Fi, and decent background music — what else do you need?",
            imageUrl: "/groupPic.png",
        },
        {
            id: 5,
